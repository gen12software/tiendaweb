...
export default function PaymentStep({ contact, shipping, selectedMethod, subtotal, shippingTotal, total, currencySymbol, loading, onBack, onPay }: Props) {
  return (
    <div className="space-y-5">
      ...
      <div className="flex gap-3">
        ...
        <Button className="flex-1" onClick={onPay} disabled={loading}>
          {loading ? (
